...
const ServiceMedicalPatient = () => {
    ...
    return (
        <div className="container" data-aos="fade-up">
            ...
            {/* --- 행정 섹션 (다시 이미지 우측) --- */}
            <div className="medical-section mb-5 pb-5">
                <h3 className="fw-bold mb-4 text-primary-emphasis border-start border-4 border-primary ps-3">소송
                    외</h3>
                <div className="row align-items-center mb-4 gx-lg-5">
                    <div className="col-lg-5">
